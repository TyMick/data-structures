...
class MinHeap:
    """
    A binary min heap implemented as an implicit data structure. Keys are stored as a
    ...
    located at `2i` and `2i + 1`, and its parent will be located at `math.floor(i / 2)`.
    All parent nodes are less than or equal to their child nodes.
    """
